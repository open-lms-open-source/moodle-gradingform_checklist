...
$string['checklistmappingexplained'] = 'De kleinst mogelijke score voor deze checklist is <b>{$a->minscore} punten</b>. Deze wordt omgezet naar het minimumcijfer dat beschikbaar is in deze module (wat nul is, tenzij de schaal wordt gebruikt). De maximumscore <b>{$a->maxscore} points</b> wordt omgezet in het maximumcijfer.<br />Tussenliggende scores worden omgezet en afgerond naar het dichtstbijzijnde beschikbare cijfer.<br />Als een schaal wordt gebruikt in plaats van een cijfer, wordt de score omgezet naar de schaalelementen alsof dit opeenvolgende gehele getallen waren.';
