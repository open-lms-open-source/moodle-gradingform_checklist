...
$string['backtoediting'] = 'Takaisin muokkaukseen';
$string['checked'] = 'Valittu';
...
$string['checklistmappingexplained'] = 'Tämän tarkistuslistan pienin mahdollinen tulos on <b>{$a->minscore} pistettä</b> ja se muunnetaan alhaisimmaksi tässä moduulissa saatavilla olevaksi arvosanaksi (joka on nolla, ellei asteikkoa käytetä). Suurin mahdollinen tulos <b>{$a->maxscore} pistettä</b> muunnetaan korkeimmaksi arvosanaksi.<br />Keskitason tulokset muunnetaan vastaavasti ja pyöristetään lähimmäksi saatavilla olevaksi arvosanaksi.<br />Jos arvosanan sijaan käytetään asteikkoa, pisteet muunnetaan asteikon elementeiksi aivan kuin ne olisivat peräkkäisiä kokonaislukuja.';
