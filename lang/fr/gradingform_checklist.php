...
$string['checklistmappingexplained'] = 'Le score minimal possible pour cette liste de contrôle est de <b>{$a->minscore} points</b> et il sera converti en note minimale disponible dans ce module (qui est zéro sauf si l\'échelle est utilisée).
Le score maximal de <b>{$a->maxscore} points</b> sera converti en note maximale.<br />
