...
$string['checklistmappingexplained'] = 'La puntuació mínima possible per a aquesta llista de verificació és de <b>{$a->minscore} punts</b> i es convertirà al grau mínim disponible en aquest mòdul (que és zero, tret que s\'utilitzi l\'escala).
La puntuació màxima de <b>{$a->maxscore} punts</b> es convertirà al grau màxim.<br />
