...
$string['checklistmappingexplained'] = 'คะแนนต่ำสุดที่เป็นไปได้สำหรับรายการตรวจสอบนี้คือ <b>{$a->minscore} คะแนน</b> และจะถูกแปลงเป็นเกรดต่ำสุดที่มีอยู่ในโมดูลนี้ (ซึ่งมีค่าเป็นศูนย์เว้นแต่จะใช้เกณฑ์คะแนน)
คะแนนสูงสุด <b>{$a->maxscore} คะแนน</b> จะถูกแปลงเป็นเกรดสูงสุด<br />
คะแนนกลางจะถูกแปลงตามลำดับและถูกปัดเศษเป็นเกรดที่มีอยู่ที่ใกล้เคียงที่สุด<br />
