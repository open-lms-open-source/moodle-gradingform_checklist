...
$string['checklistmappingexplained'] = 'คะแนนขั้นต่ำที่เป็นไปได้สำหรับรายการตรวสอบนี้คือ <b>{$a->minscore} คะแนน</b> และจะถูกแปลงเป็นเกรดขั้นต่ำที่พร้อมใช้งานในโมดูลนี้ (ซึ่งจะเป็นศูนย์นอกเสียจากจะใช้สเกล)
คะแนนขั้นสูง <b>{$a->maxscore} คะแนน</b> จะถูกแปลงเป็นเกรดขั้นสูง<br />
คะแนนขั้นกลางจะถูกแปลงตามลำดับ และจะปัดเศษเป็นเกรดที่ใช้ได้ที่ใกล้เคียงที่สุด<br />
...
$string['groupremark'] = 'หมายเหตุของกลุ่มสำหรับ "{$a}"';
