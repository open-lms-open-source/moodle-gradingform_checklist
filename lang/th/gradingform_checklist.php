...
$string['checklistmappingexplained'] = 'คะแนนขั้นต่ำที่เป็นไปได้สำหรับรายการตรวสอบนี้คือ&nbsp;<b>{$a->minscore} คะแนน</b>&nbsp;และจะถูกแปลงเป็นเกรดขั้นต่ำที่พร้อมใช้งานในโมดูลนี้ (ซึ่งจะเป็นศูนย์นอกจากจะใช้สเกล) คะแนนขั้นสูง&nbsp;<b>{$a->maxscore} คะแนน</b>&nbsp;จะถูกแปลงเป็นเกรดขั้นสูง<br />คะแนนขั้นกลางจะถูกแปลงตามลำดับ และจะปัดเศษเป็นเกรดที่ใช้ได้ที่ใกล้เคียงที่สุด<br />หากใช้สเกลแทนการใช้เกรด คะแนนจะถูกแปลงเป็นองค์ประกอบของสเกลราวกับเป็นจำนวนเต็มที่ต่อเนื่องตามลำดับ';
...
$string['regrademessage1'] = 'คุณกำลังจะบันทึกการเปลี่ยนแปลงในรายการตรวจสอบที่ใช้สำหรับการให้เกรดแล้ว โปรดระบุว่าจำเป็นต้องทบทวนเกรดที่มีอยู่เดิมหรือไม่ หากคุณตั้งค่านี้ รายการตรวจสอบจะถูกซ่อนจากผู้เรียนจนกว่ารายการจะได้รับการให้เกรดใหม่';
...
$string['maxlengthalert'] = 'ฟิลด์อินพุตมีความยาวสูงสุด {$a} อักขระ';
