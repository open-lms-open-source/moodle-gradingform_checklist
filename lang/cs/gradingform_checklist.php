...
$string['checklistmappingexplained'] = 'Minimální možné skóre tohoto kontrolního seznamu je <b>{$a->minscore} bodů</b> a převede se na minimální klasifikaci dostupnou v tomto modulu (která je nula, pokud není použita stupnice). Maximální skóre <b>{$a->maxscore} bodů</b> se převede na maximální klasifikaci.<br />Průběžné skóre se příslušně převede a zaokrouhlí na nejbližší dostupnou klasifikaci.<br />Pokud je místo klasifikace použita stupnice, převede se skóre na prvky stupnice, jako by to byla po sobě jdoucí celá čísla.';
...
$string['regrademessage1'] = 'Chystáte se uložit změny kontrolního seznamu, který již byl použit při klasifikaci. Rozhodněte, zda by existující klasifikace měly být zkontrolovány a revidovány. Pokud ano, bude kontrolní seznam studentům skrytý, dokud nebudou jejich položky znovu klasifikovány.';
...
$string['maxlengthalert'] = 'Toto vstupní pole má maximální délku {$a} znaků';
